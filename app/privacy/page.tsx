...
export const metadata = {
  title: "B2C Privacy & Terms | zimji",
  description:
    "zimji B2C Consumers Privacy & Terms Policy — Kenya DPA 2019 and India DPDP Act 2023.",
};
    ...
    <main className="min-h-screen bg-paper">
      ...
      <article className="mx-auto max-w-3xl px-4 pb-16 pt-28 sm:px-6 sm:pb-24 sm:pt-32">
        ...
        <h1 className="mt-2 font-display text-3xl font-semibold text-ink sm:text-4xl">
          B2C Consumers Privacy &amp; Terms Policy
        </h1>
        <p className="mt-2 text-sm text-ink-muted">
          zimji Virtual Try-On Platform – B2C Privacy &amp; Terms
        </p>
        ...
        <div className="mt-10 space-y-10">
          <Section title="1. Introduction">
            <p>
              zimji (“we”, “us”, “our”) respects your privacy and is committed to
              protecting your personal data. This Privacy &amp; Terms Policy
              explains how we collect, use, and protect your information when you
              use our AI Virtual Try-On Platform for consumers (“B2C Service”),
              in compliance with the Kenya Data Protection Act, 2019 and the
          ...
          <Section title="8. Terms of Service">
        ...
        <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-ink/10 pt-6">
          ...
          <div className="flex flex-wrap gap-4 text-sm font-semibold">
            <Link href="/cookies" className="text-sage hover:text-sage-dark">
              Cookies
            </Link>
